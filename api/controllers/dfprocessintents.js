...
console.log(JSON.parse("[" + request.body.input.bodyjson.result.contexts[0].name + "]"));
console.log(typeof(JSON.parse("[" + request.body.input.bodyjson.result.contexts[0].name + "]")));
